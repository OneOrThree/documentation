...
export default function NavLink({ d, cids, styles }: { d: NavLinkData; cids: string[]; styles: NavLinkStyles }) {
  return (
    <a data-cid={cids[0]} className={cn("h-[2.575rem] border border-solid flex py-[0.4rem] pr-[0.95rem] pl-2 rounded-[999px] items-center gap-[0.55rem] text-sm leading-[1.4375rem] cursor-pointer", styles.className)} data-component="button" href={d.href} aria-current={d.ariacurrent}>
