...
export default function Tile4({ d, cids, styles }: { d: Tile4Data; cids: string[]; styles: Tile4Styles }) {
  return (
    <div data-cid={cids[0]} className="h-[109.7px] min-h-11.5 border border-solid border-color-001 flex relative max-h-37.5 pt-1.5 pb-[0.3125rem] px-[0.5625rem] rounded-md flex-col justify-center gap-px text-center bg-surface cursor-pointer" id={d.id}>
