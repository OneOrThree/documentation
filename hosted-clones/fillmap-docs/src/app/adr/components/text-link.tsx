...
export default function TextLink({ d, cids, styles }: { d: TextLinkData; cids: string[]; styles: TextLinkStyles }) {
  return (
    <a data-cid={cids[0]} className={cn("border-b border-solid border-b-surface-2 grid py-[1.0625rem] px-2 items-center gap-4 cursor-pointer grid-cols-[46px_1fr_auto] max-md:grid-cols-[34px_269px]", styles.className)} data-component="link" href={d.href}>
      {" "}
